...
simulation_end_epoch = DateTime(2027, 1, 1).epoch()
...
reference_area = 0.1 * 0.1  # Average projection area of a 3U CubeSat
...
initial_state = element_conversion.keplerian_to_cartesian_elementwise(
    ...
    semi_major_axis=6378e3 + 500e3,  # meters
    eccentricity=4.03294322e-03,  # unitless
    inclination=1.71065169e00,  # radians
    argument_of_periapsis=1.31226971e00,  # radians
    longitude_of_ascending_node=3.82958313e-01,  # radians
    true_anomaly=3.07018490e00,  # radians
)
...
time_days = dep_vars_array[:, 0] / 86400
...
plt.plot(time_days, acceleration_norm_pm_sun, label="PM Earth")

# Point Mass Gravity Acceleration Moon
acceleration_norm_pm_moon = dep_vars_array[:, 13]
plt.plot(time_days, acceleration_norm_pm_moon, label="Aerodynamic Earth")
